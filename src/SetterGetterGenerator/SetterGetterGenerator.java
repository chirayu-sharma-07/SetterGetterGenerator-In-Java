package SetterGetterGenerator;
import java.lang.reflect.*; // Including this for Reflection API
import java.util.*; //Including this for to use Java Collection Classes
import java.io.*; // Including this for file handling
...
{
System.out.println("Usage : java classpath path_to_jar_file;. SetterGetterGenerator.SetterGetterGenerator class_name constructor=true/false");
return;
}
if(cs.length==2)
{
if(cs[1].equalsIgnoreCase("constructor=true")==false && cs[1].equalsIgnoreCase("constructor=false")==false)
{
System.out.println("Usage : java classpath path_to_jar_file;. SetterGetterGenerator.SetterGetterGenerator class_name constructor=true/false");
return;
}
}
String className=cs[0];
try
{
...
String line;
Class fieldType;
if(cs.length==1 || (cs.length==2 && cs[1].equalsIgnoreCase("constructor=true")))
{
